...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes, where_bn, zero_init_residual=False,
        ...
        self.layer4 = self._make_layer(block, 512, layers[3], use_bn=where_bn[3], stride=2,
    ...
    def _make_layer(self, block, planes, blocks, use_bn, stride=1, dilate=False):
        ...
        for _ in range(1, blocks):
            layers.append(block(self.inplanes, planes, use_bn, groups=self.groups,
...
def resnet50(pretrained=False, progress=True, use_bn=False,  where_bn=[0, 0, 0, 0], **kwargs):
    ...
    """
    return _resnet('resnet50', Bottleneck, [3, 4, 6, 3], pretrained, progress, use_bn=use_bn, where_bn=where_bn,
                   **kwargs)


def resnet101(pretrained=False, progress=True, use_bn=False,  where_bn=[0, 0, 0, 0], **kwargs):
