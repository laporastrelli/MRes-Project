...
def _vgg(arch, cfg, batch_norm, pretrained, progress, where_bn, normalization, **kwargs):
    if pretrained:
        kwargs['init_weights'] = False
    model = VGG(make_layers(cfgs[cfg], batch_norm=where_bn, normalization=normalization), **kwargs)
    '''if pretrained:
